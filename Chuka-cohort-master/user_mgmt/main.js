...
let userIndex = document.getElementById('userIndex'); // Hidden field to track user index
...
createUserForm.addEventListener('submit', (event)=>{
    ...
    if(user == true){
        ...
        allUsers[parseInt(userIndex.value)] = newUser;
        userIndex.value = ''; 
...
function displayUsers(){
    ...
    users.forEach((user, index)=>{
        ...
        deleteUserbtn.style.marginLeft = '10px'
        ...
        updateUserbtn.style.marginTop = '10px'
        updateUserbtn.addEventListener('click', () => {
            ...
            submitButton.value = 'Update Account'; 
        });
